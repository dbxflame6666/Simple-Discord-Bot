...
class crime(commands.Cog):
    ...
    @bridge.bridge_command(description='Do a crime to earn a lot of Coins')
    ...
    async def crime(self, ctx):
        ...
        if Chance > 60:
            ...
            eventP = random.choice(events.crimeP(coins, eco))
            ...
            eventN = random.choice(events.crimeN(coinsN, eco))
